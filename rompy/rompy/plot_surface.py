...
def plot_map(lon,lat,data,filename='/Users/lederer/tmp/rompy.map.png'):
...
#	print(lllat,urlat,lllon,urlon)
	m = Basemap(projection='merc',llcrnrlat=lllat,urcrnrlat=urlat,llcrnrlon=lllon,urcrnrlon=urlon,resolution='i',ax=ax)
	x,y = m(*(lon,lat))
