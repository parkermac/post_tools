...
daves_sections = eval('''
{
	'AI_WB':{
		...
		'PRISM_ctd_ind':[4, 9, 14, 18, 27, 36, 56, 67],
		'label':['Adm. Inlet', 'Triple Jxn.', 'Saratoga Pass.', 'Skagit R.'],
		'label_ind':[1, 31, 56, 86]
	},
	...
	'AI_HC':{
		...
		'PRISM_ctd_ind':[2, 8, 14, 20, 29, 36, 40, 46, 50, 56, 63, 70, 75, 82, 88],
		'label':['Adm. Inlet', 'Sill', 'Dabob Bay', 'Hoodsport', 'Lynch Cove'],
		'label_ind':[1, 36, 56, 82, 93]
	},
	...
	'JdF_SoG':{
		...
		'IOS_ctd_ind':[16, 23, 28, 36, 41, 47, 58, 73],
		'JEMS_ctd_ind':[1, 7],
		'label':['JdF', 'Haro St.', 'Bndy. Pass', 'Fraser R.'],
		'label_ind':[1, 23, 41, 80]
	}
}
''',{},{})
